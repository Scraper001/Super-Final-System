    ...
    <div class="flex flex-col md:flex-row justify-between items-center">
        ...
        <div class="flex flex-col items-center md:items-end">
            ...
            <div class="text-xs text-gray-400 mt-1 flex space-x-2">
                ...
                <span id="cashDrawerStatus" class="text-orange-500">🔌 Drawer: <span id="drawerStatusText">Checking...</span></span>
            </div>
        </div>
    </div>
</footer>
...
#demoCalcStatus, #reservationStatus, #cashDrawerStatus {
    cursor: pointer;
...
#demoCalcStatus:hover, #reservationStatus:hover, #cashDrawerStatus:hover {
